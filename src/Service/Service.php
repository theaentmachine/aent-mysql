...
use TheAentMachine\AentMysql\Service\Exception\EmptyAttributeException;
use TheAentMachine\AentMysql\Service\Exception\KeysMissingInArrayException;
use TheAentMachine\AentMysql\Service\Exception\VolumeTypeException;
...
class Service
{
     ...
     * @throws VolumeTypeException
     */
    public function serialize(bool $checkValidity = false): array
    {
        if($checkValidity){
            $this->checkValidity();
        }
